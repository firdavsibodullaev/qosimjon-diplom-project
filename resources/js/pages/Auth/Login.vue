<template>
	<AuthLayout>
		<div
			class="bg-[#f5f5f5] h-[100vh] w-[100vw] flex justify-center items-center overflow-hidden"
		>
			<div
			...
			>
				<p class="w-full text-xl text-center mb-1">
					<strong>{{ $env.appName }}</strong>
				</p>
				<p class="w-full text-lg text-center mb-6 text-gray-600">
					Tizimga kirish
				</p>
				<Spinner type="main">
					<a-form
